...
<head>
    ...
    <title>Reporting a inversores — Curso SaaS</title>
...
<body class="p-6 md:p-10">
    <div class="container mx-auto max-w-5xl">
        ...
        <header class="text-center py-8">
            ...
            <h1 class="text-4xl md:text-5xl font-black mb-4 gradient-text">Reporting a inversores</h1>
        </header>

        <main class="section-card">
            <p class="module-p">En este módulo hablamos de cómo reportar a inversores y las principales herramientas que se utilizan: el One Pager y el Data Room.</p>
            ...
            <p class="video-label">📺 Enlace al video de reporting</p>
            <div class="resource-row"><a class="resource-btn btn-secondary" href="/metricas/reporting.html" target="_blank" rel="noopener"><span>📕</span> Contenido reporting: Data Room y One Pager</a></div>
        </main>
