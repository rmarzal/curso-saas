...
<head>
    ...
    <title>Pricing SaaS — Curso SaaS</title>
...
<body class="p-6 md:p-10">
    <div class="container mx-auto max-w-5xl">
        ...
        <header class="text-center py-8">
            ...
            <h1 class="text-4xl md:text-5xl font-black mb-4 gradient-text">Pricing SaaS</h1>
        </header>
        ...
        <main class="section-card">
            ...
            <p class="video-label">📺 Video Pricing</p>
            <div class="resource-row"><a class="resource-btn btn-secondary" href="/metricas/pricing.html" target="_blank" rel="noopener"><span>📕</span> Contenido de soporte de pricing</a></div>
            <div class="callout"><strong>Caso práctico:</strong> Diseña tu estrategia de pricing o evalúa tu estrategia actual.</div>
        </main>
